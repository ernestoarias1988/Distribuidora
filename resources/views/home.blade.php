...
<div class="col-12 text-center">
    ...
    @if (Auth::user()->role_id=="1" || Auth::user()->role_id=="Administrador")
...
@foreach([
["productos", "vender","ventas", "clientes","usuarios", "reportes"]
] as $modulos)
<div class="col-10 pb-2">
    <div class="row">
        ...
        <div class="col-10 col-md-3">
            <div class="card">
                @php
                    $iconFile = $modulo === 'reportes' ? 'reportes.png' : "$modulo.png";
                @endphp
                <img style="max-width:100%;width:auto;height:auto;" class="card-img-top" src="{{ url("/img/$iconFile") }}" alt="{{ $modulo }}">
                <div class="card-body">
