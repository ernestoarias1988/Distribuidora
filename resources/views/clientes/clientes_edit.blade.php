    ...
    <div class="col-12">
        ...
        <form method="POST" action="{{route("clientes.update", [$cliente])}}">
            ...
            <div class="form-group">
                ...
                <input required value="{{$cliente->nombre}}" autocomplete="off" name="nombre" class="form-control" type="text" placeholder="Nombre">
            </div>
            <div class="form-group">
                <label class="label">Teléfono</label>
                <input required value="{{$cliente->telefono}}" autocomplete="off" name="telefono" class="form-control" type="number" placeholder="Teléfono">
            </div>
            ...
            <div class="form-group">
                ...
                <input required value="{{$cliente->direccion}}" autocomplete="off" name="direccion" class="form-control" type="text" placeholder="Dirección">
            </div>
